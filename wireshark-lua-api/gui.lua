...
MENU_TELEPHONY_UNSORTED = 8
MENU_TELEPHONY_ANSI = 9
MENU_TELEPHONY_GSM = 10
MENU_TELEPHONY_3GPP_UU = 11
MENU_TELEPHONY_MTP3 = 12
MENU_TELEPHONY_SCTP = 13
...
---**DEPRECATED** Use MENU_ANALYZE_UNSORTED instead.
---@deprecated
MENU_PACKET_ANALYZE_UNSORTED = 0

---**DEPRECATED** Use MENU_STAT_UNSORTED instead.
---@deprecated
MENU_PACKET_STAT_UNSORTED = 2

---**DEPRECATED** Use MENU_ANALYZE_CONVERSATION instead.
---@deprecated
...
---**DEPRECATED** Use MENU_STAT_GENERIC instead.
---@deprecated
MENU_STAT_CONVERSATION_LIST = 4

---**DEPRECATED** Use MENU_STAT_ENDPOINT instead.
---@deprecated
MENU_STAT_ENDPOINT_LIST = 5

---**DEPRECATED** Use MENU_STAT_RESPONSE instead.
---@deprecated
MENU_STAT_RESPONSE_TIME = 6

---**DEPRECATED** Use MENU_STAT_RSERPOOL instead.
---@deprecated  
MENU_STAT_TELEPHONY = 8

---**DEPRECATED** Use MENU_TELEPHONY_3GPP_UU instead.  
---@deprecated
MENU_STAT_TELEPHONY_3GPP_UU = 11

---**DEPRECATED** Use MENU_TELEPHONY_ANSI instead.
---@deprecated
MENU_STAT_TELEPHONY_ANSI = 9

---**DEPRECATED** Use MENU_TELEPHONY_GSM instead.
---@deprecated 
MENU_STAT_TELEPHONY_GSM = 10

---**DEPRECATED** Use MENU_TELEPHONY_MTP3 instead.
---@deprecated
MENU_STAT_TELEPHONY_MTP3 = 12

---**DEPRECATED** Use MENU_TELEPHONY_SCTP instead.
---@deprecated

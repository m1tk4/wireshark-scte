...
function Pref.bool(label, default, description)
    return Pref
end
...
---@return Pref pref The newly created Pref object.
function Pref.uint(label, default, description)
    return Pref
end
...
---@param description string A description of what this preference is.
---@return Pref pref The newly created Pref object.
function Pref.string(label, default, description)
    return Pref
end
...
---@return Pref pref The newly created Pref object.
function Pref.enum(label, default, description, enum, radio)
    return Pref
end
...
---@return Pref pref The newly created Pref object.
function Pref.range(label, default, description, max)
    return Pref
end
...
---@return Pref pref The newly created Pref object.
function Pref.statictext(label, description)
    return Pref
end
...
function Pref.uat(label, field_config, description, file_name)
    return Pref
end

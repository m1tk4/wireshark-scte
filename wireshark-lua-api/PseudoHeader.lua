...
---@return PseudoHeader pseudoheader A null pseudoheader.
function PseudoHeader.none() end

---Creates an ethernet pseudoheader.
---@param fcslen? number The fcs length.
---@return PseudoHeader pseudoheader The ethernet pseudoheader.
...
---@return PseudoHeader pseudoheader The ATM pseudoheader.
...
---@return PseudoHeader pseudoheader The MTP2 pseudoheader.

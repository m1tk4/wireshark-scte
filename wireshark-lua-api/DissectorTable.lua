...
--- A table of subdissectors of a particular protocol (e.g. TCP subdissectors like
--- http, smtp, sip are added to table "tcp.port").
...
---@param type? number One of ftypes.UINT8, ftypes.UINT16, ftypes.UINT24, ftypes.UINT32, ftypes.STRING, ftypes.NONE, or ftypes.GUID. Defaults to ftypes.UINT32.
...
---@return DissectorTable table The newly created DissectorTable.
...
--- Since: 4.2.0
---@param tablename string The short name of the table. Use lower-case alphanumeric, dot, and/or underscores.
---@param uiname? string The name of the table in the user interface. Defaults to the name given in tablename, but can be any string.
---@param proto Proto The Proto object that uses this dissector table.
---@return DissectorTable table The newly created DissectorTable.
function DissectorTable.heuristic_new(tablename, uiname, proto) end

--- Gets a Lua array table of all DissectorTable names - i.e., the string names you
--- can use for the first argument to DissectorTable.get().
--- Note: This is an expensive operation, and should only be used for troubleshooting.
---@return string[] names The array table of registered DissectorTable names.
function DissectorTable.list() end

--- Gets a Lua array table of all heuristic list names - i.e., the string names you
--- can use for the first argument in Proto:register_heuristic().
--- Note: This is an expensive operation, and should only be used for troubleshooting.
---@return string[] names The array table of registered heuristic list names.
...
---@return DissectorTable|nil table The DissectorTable reference if found, otherwise nil.
...
---@param pattern number|string The pattern to be matched (either an integer or a string depending on the table's type).
...
---@param pattern any The pattern to be matched, depending on the table's type.
---@return Dissector|nil dissector The Dissector handle if found, otherwise nil.
...
---@return string info A string of debug information about the DissectorTable.

...
function GcryptCipher.open(algorithm, mode, flags)
    return GcryptCipher
end
...
function GcryptCipher:ctl(cmd, buffer)
end
...
function GcryptCipher:info(what, buffer_size, nbytes)
    return nil, 0
end
...
function GcryptCipher:encrypt(out, input)
...
function GcryptCipher:checktag(tag)
    return 0, nil
end
...
function GcryptCipher:setctr(ctr, ctrlen)
end
...
---@return any userdata The requested information.
---@return number nbytes Number of bytes.
function gcry_cipher_algo_info(algorithm, what, buffer_size, nbytes)
    return nil, 0
end
...
function gcry_cipher_algo_name(algorithm)
    return ""
end
...
function gcry_cipher_map_name(name)
    return 0
end
...
function gcry_cipher_mode_from_oid(oid)
    return 0
end
...
function gcry_cipher_get_algo_keylen(algorithm)
    return 0
end
...
function gcry_cipher_get_algo_blklen(algorithm)
    return 0
end
